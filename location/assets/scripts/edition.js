...
// adding edition wise test on the wall
const edition = data[0].edition;
console.log(edition);
if(edition=='1'){
    models.push({modelName:'edition1', position:[12,8,99],scale:[7,7,7],rotation:[0,-Math.PI,0]});
}else if(edition=='2'){
    models.push({modelName:'edition2', position:[12,8,99],scale:[7,7,7],rotation:[0,-Math.PI,0]})
}else if(edition=='3'){
    models.push({modelName:'edition3', position:[12,8,99],scale:[7,7,7],rotation:[0,-Math.PI,0]})
}else if(edition=='4'){
    models.push({modelName:'edition4', position:[12,8,99],scale:[7,7,7],rotation:[0,-Math.PI,0]})
}
...
const createStairs = () => {
    ...
    createStairPlane(100, 39, 2, '/../../static/assets/FloorTexture/Rubber004_4K-JPG_Color.jpg', [-1, 102, -70], [0.5 * Math.PI, 0, 0]); // Plane at bottom for second floor
    createStairPlane(100,39,2, '/../../static/assets/FloorTexture/Rubber004_4K-JPG_Color.jpg', [-1, 152, -70], [0.5 * Math.PI, 0, 0]);  // Plane at the bottom for third floor
