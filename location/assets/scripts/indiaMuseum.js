...
const models = [
    { modelName: 'onlyEyantra', position: [40 , 14, 99], scale: [10, 10, 10], rotation: [0, -Math.PI, 0] },
    { modelName: 'virtualMuseum', position: [25 , 9, 99], scale: [6, 6, 6], rotation: [0, -Math.PI, 0] },,
...
let artifactState;
if(data.length>0){
 artifactState = data[0].state;
console.log(artifactState);
}
if(artifactState=='MH'){
    models.push({modelName:'maharashtraText', position:[18,17,99],scale:[5,5,5],rotation:[0,-Math.PI,0]});
}else if(artifactState=='GJ'){
    models.push({modelName:'gujaratText', position:[13,17,99],scale:[5,5,5],rotation:[0,-Math.PI,0]});
}else if(artifactState=='JK'){
    models.push({modelName:'jammuAndKashmirText', position:[25,17,99],scale:[5,5,5],rotation:[0,-Math.PI,0]});
}else if(artifactState=='KA'){
    models.push({modelName:'karnatakaText', position:[16,17,99],scale:[5,5,5],rotation:[0,-Math.PI,0]});
    console.log("karnataka");
}else if(artifactState=="DL"){
    models.push({modelName:'delhiText', position:[10,17,99],scale:[5,5,5],rotation:[0,-Math.PI,0]});
}else if(artifactState=='GA'){
    models.push({modelName:'goaText', position:[7,17,99],scale:[5,5,5],rotation:[0,-Math.PI,0]});
}else if(artifactState=='RJ'){
    models.push({modelName:'rajasthanTextNew', position:[16,17,98.5],scale:[5,5,5],rotation:[0,-Math.PI,0]});
    console.log("rajasthan");
}else if(artifactState=='TG'){
    models.push({modelName:'telanganaText', position:[16,17,99],scale:[5,5,5],rotation:[0,-Math.PI,0]});
}else if(artifactState=='UP'){
    models.push({modelName:'uttarPradeshTextNew', position:[20,17,98.5],scale:[5,5,5],rotation:[0,-Math.PI,0]});
}
...
// instructions
const instructions = [
    { position: [-55, 20, -49], scale: [2, 2, 2], rotation: [0, 0, 0]}, //Ground Floor
    {position: [-55, 70, -49], scale: [2, 2, 2], rotation: [0, 0, 0]},  //First Floor
    // {position: [-55, 120, -49], scale: [2, 2, 2], rotation: [0, 0, 0]}, //Second Floor
    // {position: [-55, 170, -49], scale: [2, 2, 2], rotation: [0, 0, 0]}, //Third Floor
]
...
//Front wall at the end of the floor for second and third floor
const createFrontWall23 = () => {
    const geometry = new THREE.PlaneGeometry(80, 300);
    const material = new THREE.MeshStandardMaterial({ color: 0xc3bdb9, side: THREE.DoubleSide });
    const wall = new THREE.Mesh(geometry, material);
    wall.position.set(0, 251, -52);
    scene.add(wall);
}
// createFrontWall23();
